...
public class EditMessMenuActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private String MessType,VegMenu,NonVegMenu, MenuType;
...
//                    vegMenuRef.setValue(Menu.toString());
                    VegMenu = Menu.toString();
                }else{
//                    NonVegMenuRef.setValue(Menu.toString());
                    NonVegMenu = Menu.toString();
                }
...
//            });
            ...
            ArrayList<String> menuList = new ArrayList<>();
            if (!NonVegMenu.equals("NA")) {
                String[] tokens = NonVegMenu.split("\\+");
                for (int i = 0; i < tokens.length; i++) {
                    menuList.add(tokens[i]);
                }
            }
